...
/**
 * Handle proposals of Java code completion
 */
public class JavaCompletionProposals implements IJavaCompletionProposalComputer{
	...
	@Override
	/**
	 * merge EclipseProposals and cachecaProposals using strategy of heuristic mixing.
	 * Refer to the tool paper: CACHECA: A Cache Language Model Based Code Suggestion Tool
	 */
