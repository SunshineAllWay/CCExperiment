...
class FakemlngFixtures(object):
    def create_fixtures(self):
        ...
        en = Translations.objects.create(main=main, language_code='en')
        Translations.objects.create(main=main, language_code='de')
        Translations.objects.create(main=main, language_code='nl')
        fr = Translations.objects.create(main=main, language_code='fr')
