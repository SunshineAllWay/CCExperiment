...
public class AdminHandlers implements SolrCoreAware, SolrRequestHandler
{
  ...
  public String getSourceId() {
    return "$Id: AdminHandlers.java 898152 2010-01-12 02:19:56Z ryan $";
  }
  public String getSource() {
    return "$URL: http://svn.apache.org/repos/asf/lucene/solr/branches/newtrunk/solr/src/java/org/apache/solr/handler/admin/AdminHandlers.java $";
  }
