...
final class URI
{
          ...
          throws MalformedURIException
  {
    ...
    if (p_host == null)
    {
      ...
      {
        throw new MalformedURIException(
          Utils.messages.createMessage(MsgKey.ER_NO_USERINFO_IF_NO_HOST, null)); 
      }
      if (p_port != -1)
      {
        throw new MalformedURIException(
          Utils.messages.createMessage(MsgKey.ER_NO_PORT_IF_NO_HOST, null)); 
      }
    }
    if (p_path != null)
    {
      ...
      {
        throw new MalformedURIException(
          Utils.messages.createMessage(MsgKey.ER_NO_QUERY_STRING_IN_PATH, null)); 
      }
      if (p_path.indexOf('#') != -1 && p_fragment != null)
      {
        throw new MalformedURIException(
          Utils.messages.createMessage(MsgKey.ER_NO_FRAGMENT_STRING_IN_PATH, null)); 
      }
    }
    setScheme(p_scheme);
    setHost(p_host);
          ...
          throws MalformedURIException
  {
    ...
    {
      throw new MalformedURIException(
        Utils.messages.createMessage(MsgKey.ER_CANNOT_INIT_URI_EMPTY_PARMS, null)); 
    }
  ...
  private void initializePath(String p_uriSpec) throws MalformedURIException
  {
    ...
    while (index < end)
    {
      ...
      if (testChar == '%')
      {
        ...
        {
          throw new MalformedURIException(
            Utils.messages.createMessage(MsgKey.ER_PATH_CONTAINS_INVALID_ESCAPE_SEQUENCE, null)); 
        }
      }
      ...
      {
        if ('\\' != testChar)
          throw new MalformedURIException(Utils.messages.createMessage(MsgKey.ER_PATH_INVALID_CHAR, new Object[]{String.valueOf(testChar)})); 
      }
      index++;
    }
  ...
  public void setPort(int p_port) throws MalformedURIException
  {
    if (p_port >= 0 && p_port <= 65535)
    {
      ...
      {
        throw new MalformedURIException(
          Utils.messages.createMessage(MsgKey.ER_PORT_WHEN_HOST_NULL, null)); 
      }
    }
    else if (p_port != -1)
    {
  ...
  public void setFragment(String p_fragment) throws MalformedURIException
  {
    ...
    {
      throw new MalformedURIException(
        Utils.messages.createMessage(MsgKey.ER_FRAG_FOR_GENERIC_URI, null)); 
    }
    else if (getPath() == null)
    {
      throw new MalformedURIException(
        Utils.messages.createMessage(MsgKey.ER_FRAG_WHEN_PATH_NULL, null)); 
    }
    else if (!isURIString(p_fragment))
    {
      throw new MalformedURIException(Utils.messages.createMessage(MsgKey.ER_FRAG_INVALID_CHAR, null)); 
    }
    else
    {
