...
public class SVGConverterTest extends DefaultTestSuite {
    public SVGConverterTest(){
        ...
        t = new ConverterOutputTest("samples/anne.svg",  
                                    "test-reports/anne.png", 
                                    "test-references/samples/anne.png"); 
        addTest(t);
        t.setId("OutputTest.plain");
        t = new ConverterOutputTest("samples/anne.svg#svgView(viewBox(0,0,100,200))",  
                                    "test-reports/anne.png", 
                                    "test-references/samples/anneViewBox1.png"); 
        addTest(t);
