...
public class FastLRUCache<K,V> implements SolrCache<K,V> {
  ...
  public String getSourceId() {
    return "$Id: FastLRUCache.java 919871 2010-03-06 22:49:24Z yonik $";
  }
  public String getSource() {
    return "$URL: http://svn.apache.org/repos/asf/lucene/solr/branches/newtrunk/solr/src/java/org/apache/solr/search/FastLRUCache.java $";
  }
  public URL[] getDocs() {
    return null;
  }
